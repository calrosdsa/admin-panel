...
const Menu:React.FC<Props> = ({open,setOpen}) =>{
    ...
    return(
      ...
      >
        <div className='absolute inset-0 overflow-hidden'>
          ...
          <div className='fixed inset-y-0  left-0 w-2/3 xl:top-[54px] sm:w-3/6 md:w-2/5 xl:w-1/6 flex'>
            <Transition.Child
              as='div'
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 7.5h1.5m-1.5 3h1.5m-7.5 3h7.5m-7.5 3h7.5m3-9h3.375c.621 0 1.125.504 1.125 1.125V18a2.25 2.25 0 01-2.25 2.25M16.5 7.5V18a2.25 2.25 0 002.25 2.25M16.5 7.5V4.875c0-.621-.504-1.125-1.125-1.125H4.125C3.504 3.75 3 4.254 3 4.875V18a2.25 2.25 0 002.25 2.25h13.5M6 7.5h3v3H6v-3z" />
   ...
   0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                ...
                <h3 className='pl-14'>Usuarios</h3>
            </div>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" />
         ...
         <h3 className='pl-14'>Descargar reporte</h3>
