...
const DashboardData = ()=>{
    ...
    return(
        <div className="w-full px-1 mx-auto lg:px-5 lg:pt-4 flex flex-col lg:h-screen lg:overflow-auto ">
        <div className=''>

            <div className="flex flex-wrap gap-x-2 gap-y-3">
          <div onClick={()=>downloadReport("1",ReporteId.USER_RED)}
           className='button w-min flex items-center space-x-2'>
            <svg height="30px" width="30px" version="1.1" id="Layer_1" className="fill-white p-[1px]"
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" />
     ...
     <span className=" whitespace-nowrap text-sm font-semibold">Descargar reporte general (Excel)</span>
        ...
        <div className="flex flex-wrap gap-x-2 gap-y-3 mt-2">
          <div onClick={()=>downloadReportExcel("1",ReporteId.USER_RED_EXCEL)}
           className='button w-min flex items-center space-x-2'>
...
<path fill="#FFF" d="M32 15H39V18H32zM32 25H39V28H32zM32 30H39V33H32zM32 20H39V23H32zM25 15H30V18H25zM25
 ...
 4c0.078-0.271,0.224-0.68,0.439-1.22L19.237,17h3.515l-4.199,6.939l4.316,7.059h-3.74V31z"/></svg>
     <span className=" whitespace-nowrap text-sm font-semibold">Usarios de la red</span>
           ...
           <div onClick={()=>downloadReportExcel("0",ReporteId.ALL_USER_EXCEL)}
           className='button w-min flex items-center space-x-2'>
        <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="30px" height="30px">
<path fill="#4CAF50" d="M41,10H25v28h16c0.553,0,1-0.447,1-1V11C42,10.447,41.553,10,41,10z"/>
<path fill="#FFF" d="M32 15H39V18H32zM32 25H39V28H32zM32 30H39V33H32zM32 20H39V23H32zM25 15H30V18H25zM25
