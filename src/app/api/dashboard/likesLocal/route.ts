...
export async function GET(request:Request) {
  ...
  try{
    //   const body = await request.json()
      const res = await fetch(`${API_URL}/apiFB/public/facebook/reactionSevenUserWifi`,{
        method:"GET",
        headers:{
...
//     if(req.method == 'GET'){
//       try{
//           const response = await axios.get(`${API_URL}/apiFB/public/facebook/reactionSevenUserWifi`,{
//               headers:{
