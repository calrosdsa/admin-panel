...
//    console.log(token)
  ...
  try{
    //   const body:Cupo = await request.json()
      const res = await fetch(`${API_URL}/apiFB/public/dispositivo/listbyidUserwifi`,{
        method:'POST',
...
//         const { id } = req.query
//         try{
//             const response = await axios.post(`${API_URL}/apiFB/public/dispositivo/listbyidUserwifi`,
