...
import { donwloadUserReportExcel, donwloadUserReportPdf, getUserList } from "@/context/actions/userActions";
import { useAppDispatch, useAppSelector } from "@/context/reduxHooks";
import { userActions } from "@/context/slices/user-slice";
import { ReporteId } from "@/data/models/type/dashboard-model";
import { Pagination, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow, Typography } from "@mui/material";
...
const Users = () =>{
    ...
    const handleChangePage = (event: unknown, newPage: number) => {
      ...
      const handleChangeRowsPerPage = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setPage(0);
        dispatch(getUserList(1,+event.target.value))
      };
    ...
    const downloadReport = (idProgress:number) =>{
        ...
        const source = cancelToken.source();
            ...
            dispatch(donwloadUserReportPdf(idProgress,id,source))
        }
    }

    const downloadReportExcel = (idProgress:number) =>{
        const cancelToken = axios.CancelToken;
        const source = cancelToken.source();
            if(dashboardState.ongoingProcess.includes(idProgress)){
                toast.info("Hay una descarga en curso.")
            ...
            dispatch(donwloadUserReportExcel(idProgress,id,source))
        }
    }
    ...
    useEffect(()=>{
        // if(userState.userPagination?.users.length == 0){
    ...
    return(
        ...
        <Layout>
            ...
            <div className="p-2 pt-12 xl:pt-2 relative  ">


        <div className="flex flex-wrap gap-x-2 gap-y-3 pb-2">
...
<g>
	...
	<polygon style={{fill:"#D1D3D3"}} points="219.821,50.525 270.346,50.525 219.821,0 	"/>
     ...
     <span className=" whitespace-nowrap text-sm font-semibold">Usarios de la red</span>
          ...
          <button onClick={()=>downloadReportExcel(ReporteId.USER_RED_EXCEL)}
...
<path fill="#FFF" d="M32 15H39V18H32zM32 25H39V28H32zM32 30H39V33H32zM32 20H39V23H32zM25 15H30V18H25zM25
 ...
 4c0.078-0.271,0.224-0.68,0.439-1.22L19.237,17h3.515l-4.199,6.939l4.316,7.059h-3.74V31z"/></svg>
     <span className=" whitespace-nowrap text-sm font-semibold">Usarios de la red</span>
                ...
                <TableContainer sx={{ height: "82vh" }}>
                    ...
                    <TableHead>
                        ...
                        <TableCell align="center"></TableCell>
                            ...
                            <TableCell align="left">Conexiones</TableCell>
                            <TableCell align="left">Dispositivos</TableCell>
            ...
            <div className=" absolute left-1/2 top-64 xl:top-44  z-10 -translate-x-1/2">
        ...
        :
                        userState.userPagination?.users
                            .map((item,idx) => {
                            return (
                                   ...
                                   <TableCell align="left">
                                    ...
                                    <TableCell align="left">
                                        ...
                                        className=" cursor-pointer underline whitespace-nowrap">
                                            <span  onClick={()=>navigateToUserProfilePage(item.id)}>
                                    {item.fullName}
                                            </span>
                                        </Typography>
                                    </TableCell>
                ...
                <TablePagination
                    ...
                    component="div"
                    count={userState.userPagination?.total || 0}
