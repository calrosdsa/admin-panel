...
const CreateUserNegocioDialog:React.FC<Props>=({
  openModal,closeModal,
    ...
    const {nombre,email,password,passwordConfirm} = formData
  ...
  const onSubmit = (e:FormEvent<HTMLFormElement>)=>{
   ...
   dispatch(resetPassword(password,passwordConfirm,closeModal))
  }
  return (
    <>
    {/* {openDialogConfirm&&
    <DialogConfirmation
    performAction={()=>setOpenDialogConfirm(false)}
    descartar={()=>{
