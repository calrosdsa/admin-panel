...
const deletedSubmitedImage = () =>{
  ...
  useEffect(()=>{
   updateHtmlCode()
    ...
    return(
        <div className={`grid grid-cols-5 w-full  ${htmlCode == undefined? " transition-all opacity-0 duration-1000":
        " transition-all opacity-100 duration-1000"}`}>
            {/* <textarea className="w-1/2" name="" id="" cols={30} rows={10}
            value={htmlString}></textarea> */}
            <div className="overflow-auto h-screen p-3 space-y-4 col-span-2 " >
