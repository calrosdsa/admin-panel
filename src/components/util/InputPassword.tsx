...
const InputPassword = ({onChange,password,label,name}:Props) =>{
    ...
    return(
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" 
         className="w-5 h-5 absolute bottom-[12px] left-[5px] text-gray-400">
  <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
</svg>

<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"
onClick={()=>setShow(!show)}
 className="w-5 h-5 absolute bottom-[12px] right-[5px] text-gray-400 cursor-pointer">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
    ...
    <input id="password" name={name}  type={show? 'text':`password`}
      required
        ...
        value={password}
        minLength={8}
        className=" border-[1px] rounded-lg  peer rounded-b-lg   p-2 h-11 w-full
