 ...
 if(iframe != undefined){
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" />
      ...
      <div className="flex px-2 mt-2 space-x-3">
          <Button color="light" onClick={()=>window.open(splashState.splashPage?.urlSplash,"_blank")}>Visitar pagina splash</Button>
          <Button color="light" onClick={()=>setConfirmDiscard(true)}>Descartar Cambios</Button>
          <Button color="light" onClick={()=>setConfirmSave(true)}>Guardar Cambios</Button>
      </div>
